<script lang="ts" context="module">
    ...
    export const variants = {
        ...
        roundOutline:
            'w-12 2xs:w-14 xs:w-16 h-12 2xs:h-14 xs:h-16 text-2xl rounded-full hover:bg-emerald-400/10',
        ghost: 'rounded-lg px-3 py-2 text-lg hover:bg-emerald-400/5 border-transparent hover:border-emerald-500/5 shadow-none',
        roundGhost:
            'rounded-full text-lg w-12 2xs:w-14 xs:w-16 h-12 2xs:h-14 xs:h-16 hover:bg-emerald-400/5 border-transparent hover:border-emerald-500/5 shadow-none',
    }
